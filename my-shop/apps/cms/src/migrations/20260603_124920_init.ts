...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('facebook', 'twitter', 'instagram', 'github');
  ...
  CREATE TABLE "pages_blocks_featured_products_product_slugs" (
  	"_order" integer NOT NULL,
  ...
  ALTER TABLE "pages_blocks_featured_products_product_slugs" ADD CONSTRAINT "pages_blocks_featured_products_product_slugs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_featured_products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_featured_products_product_slugs_order_idx" ON "pages_blocks_featured_products_product_slugs" USING btree ("_order");
  CREATE INDEX "pages_blocks_featured_products_product_slugs_parent_id_idx" ON "pages_blocks_featured_products_product_slugs" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_featured_products_product_slugs" CASCADE;
